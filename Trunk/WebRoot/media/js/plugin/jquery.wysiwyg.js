	...
	function Wysiwyg() {
		...
		this.controls = {
			...
			h1: {
				...
				visible: true,
				className: "h1",
				command: ($.browser.mozilla || $.browser.chrome || $.browser.msie || $.browser.opera) ? "FormatBlock" : "heading",
				"arguments": ($.browser.mozilla || $.browser.chrome || $.browser.msie || $.browser.opera) ? "<h1>" : "h1",
				tags: ["h1"],
				tooltip: "Header 1"
			},
			...
			h2: {
				...
				className: "h2",
				command: ($.browser.mozilla || $.browser.chrome || $.browser.msie || $.browser.opera)	? "FormatBlock" : "heading",
				"arguments": ($.browser.mozilla || $.browser.chrome || $.browser.msie || $.browser.opera) ? "<h2>" : "h2",
				tags: ["h2"],
				tooltip: "Header 2"
			},
			...
			h3: {
				...
				className: "h3",
				command: ($.browser.mozilla || $.browser.chrome || $.browser.msie || $.browser.opera) ? "FormatBlock" : "heading",
				"arguments": ($.browser.mozilla || $.browser.chrome || $.browser.msie || $.browser.opera) ? "<h3>" : "h3",
				tags: ["h3"],
				tooltip: "Header 3"
			},
			...
			insertImage: {
				uploadAction:'/file/image/fault/upload.action',
				groupIndex: 6,
				visible: true,
				exec: function () {
					var self = this;
